...
const certifications = [
  ...
  { title: "Data Solution using Power BI and Python (Matplotlib,Seaborn)", org: "Data Solution 360", year: 2025 },
];
    ...
    <div className="relative min-h-screen scroll-smooth bg-background text-foreground antialiased">
      ...
      <header className="sticky top-0 z-30 backdrop-blur supports-[backdrop-filter]:bg-background/70 border-b border-border">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6">
            <a href="#hero" className="font-semibold tracking-tight">Mehajabin Masud Portfolio</a>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-8 px-4 md:grid-cols-2 md:px-6">
          ...
          >
            <Badge className="mb-4 gap-1 bg-primary/15 text-primary hover:bg-primary/20">
              ...
              <h1 className="mb-4 text-xl font-bold leading-tight md:text-3xl">
            ...
            <div className="flex flex-wrap gap-3">
                <Button asChild size="lg">
                  <a href="/resume.pdf" download="resume.pdf" type="application/pdf" className="inline-flex items-center gap-2"><Download className="h-4 w-4"/> Download Resume</a>
                </Button>
          ...
          >
              <div className="relative mx-auto aspect-square w-64 overflow-hidden rounded-3xl border bg-gradient-to-tr from-muted to-transparent p-1 shadow-2xl md:w-80 -mt-11">
                <img
                  src="/profile.jpg"
                  alt="Professional Photo"
                  className="h-full w-full object-cover rounded-3xl bg-muted/40"
                />
            ...
            <Card>
              ...
              <CardContent className="text-muted-foreground flex flex-col items-center gap-2">
                ...
                <div className="flex gap-2">
                  <img src="/var1.jpg" alt="Dhaka International University 1" className="h-20 rounded shadow" />
                  <img src="/var2.jpg" alt="Dhaka International University 2" className="h-20 rounded shadow" />
                </div>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent className="text-muted-foreground flex flex-col items-center gap-2">
                2016
                <img src="/jhp.jpg" alt="Jhenaidah Polytechnic Institute" className="h-20 rounded shadow" />
              </CardContent>
            </Card>
          </div>
      </Section>
      ...
      <Section id="certifications">
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <div className="no-scrollbar flex snap-x gap-4 overflow-x-auto pb-2">
            ...
            {/* PDF Certificates */}
            {[1,2,3,4,5,6].map(num => (
              <Card key={`pdf-cert-${num}`} className="min-w-[280px] snap-center flex flex-col items-center justify-center">
                <CardContent className="p-6 flex flex-col items-center">
                  <div className="mb-2 flex items-center gap-2">
                    <Award className="h-5 w-5 text-primary" />
                    <span className="font-medium">Certificate {num}</span>
                  </div>
                  <a
                    href={`/${num}.pdf`}
                    target="_blank"
            ...
            <CardContent>
                <form
                  ...
                  onSubmit={async (e) => {
                    ...
                    window.location.href = `mailto:masudmehajabin@gmail.com?subject=${subject}&body=${body}`;
                    setTimeout(() => {
                      if (form) {
                        form.reset();
                ...
                <Textarea name="message" placeholder="Message" className="min-h-[120px]" required />
                  <div className="flex items-center gap-2">
                    ...
                    <Button asChild variant="secondary">
                      <a href="/resume.pdf" download="resume.pdf" type="application/pdf" className="inline-flex items-center gap-2"><Download className="h-4 w-4"/> Resume</a>
                    </Button>
                  </div>
                  <div id="contact-success-msg" style={{display:'none'}} className="text-green-600 text-sm mt-2">Message sent successfully!</div>
              </form>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent className="space-y-3">
                <a href="https://www.linkedin.com/in/masud-mehajabin/" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm hover:text-primary"><Linkedin className="h-4 w-4"/> LinkedIn</a>
                <a href="mailto:masudmehajabin@gmail.com" className="flex items-center gap-2 text-sm hover:text-primary"><Mail className="h-4 w-4"/> masudmehajabin@gmail.com</a>
                <span className="flex items-center gap-2 text-sm"><Phone className="h-4 w-4"/> 01793080005, 01935264697</span>
            </CardContent>
          </Card>
        </div>
      </Section>
